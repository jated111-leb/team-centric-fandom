...
-- Fix the Serie_A inconsistency by updating to SA
UPDATE notification_sends SET competition = 'SA' WHERE competition = 'Serie_A';

-- Update compute_analytics_summary to use friendly competition names and notifications count
...
BEGIN
  ...
  SELECT json_build_object(
    ...
    'contentStats', json_build_object(
      ...
      'byCompetition', (
        -- Use friendly names from competition_translations, show notifications count
