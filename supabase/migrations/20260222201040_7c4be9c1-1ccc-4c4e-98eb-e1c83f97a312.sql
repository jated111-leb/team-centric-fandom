-- Fix critical bug: ILIKE '%send%' matches ZERO rows because event types are
-- 'canvas.sent' and 'push_sent' (contain "sent", not "send").
-- Replace with exact IN() for safety, speed, and clarity.
